...
bool checkInputsKeyimagesDiff(const Quid::TransactionPrefix& tx);
...
const TransactionInput& getInputChecked(const Quid::TransactionPrefix& transaction, size_t index);
const TransactionInput& getInputChecked(const Quid::TransactionPrefix& transaction, size_t index, TransactionTypes::InputType type);
...
const TransactionOutput& getOutputChecked(const Quid::TransactionPrefix& transaction, size_t index);
const TransactionOutput& getOutputChecked(const Quid::TransactionPrefix& transaction, size_t index, TransactionTypes::OutputType type);

bool findOutputsToAccount(const Quid::TransactionPrefix& transaction, const AccountPublicAddress& addr,
