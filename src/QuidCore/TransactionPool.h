...
#include "QuidCore/ITimeProvider.h"
#include "QuidCore/ITransactionValidator.h"
#include "QuidCore/ITxPoolObserver.h"
...
namespace Quid {
  ...
  public:
    OnceInTimeInterval(unsigned interval, Quid::ITimeProvider& timeProvider)
  ...
  private:
    ...
    unsigned m_interval;
    Quid::ITimeProvider& m_timeProvider;
  };
  ...
  public:
    tx_memory_pool(
      ...
      Quid::ITransactionValidator& validator,
      Quid::ITimeProvider& timeProvider,
      Logging::ILogger& log);
  ...
  private:
    ...
    Quid::ITransactionValidator& m_validator;
    Quid::ITimeProvider& m_timeProvider;
