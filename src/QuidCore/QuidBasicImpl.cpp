...
namespace Quid {
  ...
  //-----------------------------------------------------------------------
  bool operator ==(const Quid::Transaction& a, const Quid::Transaction& b) {
    return getObjectHash(a) == getObjectHash(b);
  }
  //-----------------------------------------------------------------------
  bool operator ==(const Quid::Block& a, const Quid::Block& b) {
    return Quid::get_block_hash(a) == Quid::get_block_hash(b);
  }
}
