...
#include "QuidCore/BlockIndex.h"
#include "QuidCore/Checkpoints.h"
#include "QuidCore/Currency.h"
#include "QuidCore/IBlockchainStorageObserver.h"
#include "QuidCore/ITransactionValidator.h"
#include "QuidCore/SwappedVector.h"
#include "QuidCore/QuidFormatUtils.h"
#include "QuidCore/TransactionPool.h"
#include "QuidCore/BlockchainIndices.h"

#include "QuidCore/MessageQueue.h"
#include "QuidCore/BlockchainMessages.h"
#include "QuidCore/IntrusiveLinkedList.h"
...
namespace Quid {
  ...
  using Quid::BlockInfo;
  class Blockchain : public Quid::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with QuidProtocolHandler.
