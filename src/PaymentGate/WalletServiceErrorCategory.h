...
inline std::error_code make_error_code(Quid::error::WalletServiceErrorCode e) {
  return std::error_code(static_cast<int>(e), Quid::error::WalletServiceErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<Quid::error::WalletServiceErrorCode>: public true_type {};
