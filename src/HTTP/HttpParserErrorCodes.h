...
inline std::error_code make_error_code(Quid::error::HttpParserErrorCodes e) {
  return std::error_code(static_cast<int>(e), Quid::error::HttpParserErrorCategory::INSTANCE);
}
