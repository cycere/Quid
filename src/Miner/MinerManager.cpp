...
MinerManager::MinerManager(System::Dispatcher& dispatcher, const Quid::MiningConfig& config, Logging::ILogger& logger) :
...
void MinerManager::startMining(const Quid::BlockMiningParameters& params) {
...
void MinerManager::adjustBlockTemplate(Quid::Block& blockTemplate) const {
