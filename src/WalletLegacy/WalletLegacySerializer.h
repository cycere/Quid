...
public:
  WalletLegacySerializer(Quid::AccountBase& account, WalletUserTransactionsCache& transactionsCache);
...
private:
  void saveKeys(Quid::ISerializer& serializer);
  void loadKeys(Quid::ISerializer& serializer);
