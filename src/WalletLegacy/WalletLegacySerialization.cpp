...
void serialize(UnconfirmedTransferDetails& utd, Quid::ISerializer& serializer) {
...
void serialize(WalletLegacyTransaction& txi, Quid::ISerializer& serializer) {
  ...
  Quid::serializeBlockHeight(serializer, txi.blockHeight, "block_height");
...
void serialize(WalletLegacyTransfer& tr, Quid::ISerializer& serializer) {
