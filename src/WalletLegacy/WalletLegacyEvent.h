...
public:
  ...
  virtual void notify(Tools::ObserverManager<Quid::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<Quid::IWalletLegacyObserver>& observer) override
  {
