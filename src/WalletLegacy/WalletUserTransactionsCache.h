...
public:
  ...
  bool serialize(Quid::ISerializer& serializer);
  ...
  void updateTransaction(TransactionId transactionId, const Quid::Transaction& tx, uint64_t amount, const std::list<TransactionOutputInformation>& usedOutputs);
