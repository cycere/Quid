...
TransfersSyncronizer::TransfersSyncronizer(const Quid::Currency& currency, IBlockchainSynchronizer& sync, INode& node) :
...
void TransfersSyncronizer::load(std::istream& is) {
  ...
  Quid::BinaryInputStreamSerializer s(inputStream);
  uint32_t version = 0;
