...
inline std::string get_protocol_state_string(QuidConnectionContext::state s) {
  switch (s)  {
  case QuidConnectionContext::state_befor_handshake:
    return "state_befor_handshake";
  case QuidConnectionContext::state_synchronizing:
    return "state_synchronizing";
  case QuidConnectionContext::state_idle:
    return "state_idle";
  case QuidConnectionContext::state_normal:
    return "state_normal";
  case QuidConnectionContext::state_sync_required:
    return "state_sync_required";
  case QuidConnectionContext::state_pool_sync_required:
    return "state_pool_sync_required";
  case QuidConnectionContext::state_shutdown:
...
namespace std {
inline std::ostream& operator << (std::ostream& s, const Quid::QuidConnectionContext& context) {
