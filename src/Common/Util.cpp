// Copyright (c) 2011-2016 The Cryptonote 
...
std::string get_nix_version_display_string()
{
  ...
  {
    //namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\QUID_NAME
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\QUID_NAME
    // Mac: ~/Library/Application Support/QUID_NAME
    // Unix: ~/.QUID_NAME
    std::string config_folder;
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + Quid::QUID_NAME;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + Quid::QUID_NAME);
#else
    // Unix
    config_folder = (pathRet + "/." + Quid::QUID_NAME);
#endif
