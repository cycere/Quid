...
inline std::error_code make_error_code(Quid::error::WalletErrorCodes e) {
  return std::error_code(static_cast<int>(e), Quid::error::WalletErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<Quid::error::WalletErrorCodes>: public true_type {};
