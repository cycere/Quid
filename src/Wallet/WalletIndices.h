...
struct WalletRecord {
  ...
  Quid::ITransfersContainer* container = nullptr;
...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransfersContainerIndex>,
      BOOST_MULTI_INDEX_MEMBER(WalletRecord, Quid::ITransfersContainer*, container) >
  >
> WalletsContainer;

struct UnlockTransactionJob {
  uint32_t blockHeight;
  Quid::ITransfersContainer* container;
...
typedef boost::multi_index_container <
  Quid::WalletTransaction,
  boost::multi_index::indexed_by <
    boost::multi_index::random_access < boost::multi_index::tag <RandomAccessIndex> >,
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransactionIndex>,
      boost::multi_index::member<Quid::WalletTransaction, Crypto::Hash, &Quid::WalletTransaction::hash >
    >,
    boost::multi_index::ordered_non_unique < boost::multi_index::tag <BlockHeightIndex>,
      boost::multi_index::member<Quid::WalletTransaction, uint32_t, &Quid::WalletTransaction::blockHeight >
    >
  >
> WalletTransactions;

typedef std::pair<size_t, Quid::WalletTransfer> TransactionTransferPair;
typedef std::vector<TransactionTransferPair> WalletTransfers;
typedef std::map<size_t, Quid::Transaction> UncommitedTransactions;
