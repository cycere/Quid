...
namespace Quid
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public Quid::INodeObserver, public Quid::IWalletLegacyObserver, public Quid::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const Quid::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(Quid::simple_wallet& simple_wallet)
    ...
    private:
      Quid::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<Quid::NodeRpcProxy> m_node;
