...
class IQuidProtocolQueryStub: public Quid::IQuidProtocolQuery {
public:
  IQuidProtocolQueryStub() : peers(0), observedHeight(0), synchronized(false) {}

  virtual bool addObserver(Quid::IQuidProtocolObserver* observer) override;
  virtual bool removeObserver(Quid::IQuidProtocolObserver* observer) override;
