...
private:
  std::list<Quid::Block> m_chain_1;

  Quid::AccountBase m_recipient_account_1;
  Quid::AccountBase m_recipient_account_2;
  Quid::AccountBase m_recipient_account_3;
  Quid::AccountBase m_recipient_account_4;

  std::vector<Quid::Transaction> m_tx_pool;
};
