...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_2(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_mempool_1(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<Quid::Block>(events[8])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 2);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched2(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<Quid::Block>(events[14])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 3);
  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_not_switched_back(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<Quid::Block>(events[19])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);

  return true;
}
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_1(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<Quid::Block>(events[26])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);

  return true;
}//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_split_switched_back_2(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
  ...
  CHECK_TEST_CONDITION(c.get_tail_id() == get_block_hash(boost::get<Quid::Block>(events[28])));
  CHECK_TEST_CONDITION(c.get_alternative_blocks_count() == 8);
  return true;
}
//-----------------------------------------------------------------------------------------------------
/*
bool gen_simple_chain_split_1::check_orphaned_chain_1(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_alternative(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_2(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_switched_to_main(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_38(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_39(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_40(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
...
//-----------------------------------------------------------------------------------------------------
bool gen_simple_chain_split_1::check_orphaned_chain_41(Quid::core& c, size_t ev_index, const std::vector<test_event_entry> &events)
{
