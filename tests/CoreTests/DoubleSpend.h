...
public:
  ...
  bool mark_invalid_tx(Quid::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(Quid::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(Quid::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  Quid::Block m_last_valid_block;
