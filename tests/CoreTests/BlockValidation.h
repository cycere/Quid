...
public:
  ...
  bool check_block_verification_context(const Quid::block_verification_context& bvc, size_t eventIdx, const Quid::Block& /*blk*/) {
  ...
  bool check_block_purged(Quid::core& c, size_t eventIdx, const std::vector<test_event_entry>& events) {
  ...
  bool markInvalidBlock(Quid::core& c, size_t eventIdx, const std::vector<test_event_entry>& events) {
...
struct CheckBlockAccepted : public test_chain_unit_base {
  ...
  bool check_block_accepted(Quid::core& c, size_t /*eventIdx*/, const std::vector<test_event_entry>& /*events*/) {
...
struct gen_block_invalid_binary_format : public test_chain_unit_base
{
  ...
  bool generate(std::vector<test_event_entry>& events) const;
  bool check_block_verification_context(const Quid::block_verification_context& bvc, size_t event_idx, const Quid::Block& /*blk*/);
  bool check_all_blocks_purged(Quid::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool corrupt_blocks_boundary(Quid::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
