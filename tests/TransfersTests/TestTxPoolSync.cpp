...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<Quid::INode> node0;
    std::unique_ptr<Quid::INode> node1;
    std::unique_ptr<Quid::INode> node2;
    std::unique_ptr<Quid::INode> node3;
    ...
    std::vector<std::unique_ptr<Quid::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<Quid::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<Quid::INode> node2;
    std::unique_ptr<Quid::INode> node3;
    std::unique_ptr<Quid::INode> node4;
    ...
    std::vector<std::unique_ptr<Quid::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<Quid::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<Quid::ITransactionReader>> poolTxs4;
